...
<head>
    ...
    <link rel="stylesheet" href="/CSS/after_review_interior.css">
...
<body>
        ...
        <div class="content-box">
            ...
            <section class="interior-container">
                <div class="interior-banner">
                    <img src="/backend/panel/<?php echo $review['thumbnail']; ?>" alt="Thumbnail">
                </div>
    ...
    <script src="/JS/review_zoom.js"></script>
