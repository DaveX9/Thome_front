...
<head>
    ...
    <link rel="stylesheet" href="/CSS/joinwithus.css">
            ...
            <div class="apply-job" data-aos="fade-up">
                ...
                <div class="job-container" data-aos="fade-up-right">
                    <div class="job-listing">
                        ...
                        <a href="/Homepage/job1.php" class="apply-btn">Apply Now</a>
                    </div>
                    ...
                    <div class="job-listing" data-aos="fade-up">
                        ...
                        <a href="/Homepage/job2.php" class="apply-btn">Apply Now</a>
                    </div>
                    ...
                    <div class="job-listing" data-aos="fade-up-left">
                        ...
                        <a href="/Homepage/job3.php" class="apply-btn">Apply Now</a>
                    </div> 
                </div>
            </div> -->
            <?php
                    ...
                    <?php if (!empty($jobs)): ?>
                        <?php foreach ($jobs as $job): ?>
                            <div class="job-listing" data-aos="fade-up">
                                ...
                                <a href="/Homepage/job3.php?job_id=<?php echo $job['id']; ?>" class="apply-btn">Apply Now</a>
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
